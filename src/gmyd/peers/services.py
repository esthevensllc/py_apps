...
class LoadPeers:
    ...
    def get_data(self):
        ...
        null IRU, TIERONE, PUERTO, BUNDEL, CAPACIDAD, TIPO_IRU, ROUTER, null PAIS_DESTINO, null CIUDAD_DESTINO,
        null PROV_CABLE_SUBM, null NAME_CABLE_SUBM, ESTADO, null CAPA, TO_CHAR(FECHA_CREACION,'YYYY-MM-DD HH24:MI:SS'), TO_CHAR(FECHA_ACTIVACION, 'YYYY-MM-DD HH24:MI:SS'),
        TO_CHAR(null, 'YYYY-MM-DD HH24:MI:SS'), TO_CHAR(FECHA_BAJA, 'YYYY-MM-DD HH24:MI:SS'), RESP_CREACION, RESP_ACTIVACION, NULL RESP_ULTIMO_CAMBIO, RESP_BAJA
