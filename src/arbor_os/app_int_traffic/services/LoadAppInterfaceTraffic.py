...
class LoadAppInterfaceTraffic:
    ...
    def execute(self, fecha1, fecha2):
        ...
        # fecha1 = datetime.datetime.strptime('2022-02-02', '%Y-%m-%d')
        # fecha2 = fecha1 + datetime.timedelta(days=1)
        str_fecha1 = fecha1.strftime('%Y-%m-%d %H:%M:%S')
        str_fecha2 = fecha2.strftime('%Y-%m-%d %H:%M:%S')
        print("Recarga Arbor.app_interface_traffic {} - {}".format(str_fecha1, str_fecha2))
        ...
        for traffic in app_peer_traffic:
            ...
            for item in traffic['facet_values']:
                ...
                if item['facet'] == 'Interface':
                    row_to_add['description'] = item['description']
                    row_to_add['router'] = item['router']
        ...
        # print(traffic_to_insert[len(traffic_to_insert)-1])
    ...
    def __get_traffic_from_file(self, fecha1, fecha2):
        ...
        file = open(STORAGE_DIR+'arbor-os/traffic_queries_appint_'+str_fecha1+'__'+str_fecha2+'.json', 'r')
