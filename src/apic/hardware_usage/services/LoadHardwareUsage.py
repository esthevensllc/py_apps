...
class LoadHardwareUsage:
    def __init__(self, repository, mem_repo, apic_service):
    ...
    def execute(self):
        ...
        nodes_by_topology = {'pod-1': ['node-201','node-202','node-123','node-124','node-125','node-126','node-127','node-128','node-181','node-182','node-183','node-184']}
