...
def update_table(param1, param2):
    ...
    sql = 'update PSO_DATA_FIJA_TEST SET ubigeo = :param1 WHERE name = :param2'
    try:
...
if __name__ == '__main__':
    ...
    sql = """select pso.name, pl.geometry from PSO_DATA_FIJA_TEST pso
    left join (
    ...
    where pso.estado = 1 and UBIGEO IS NULL"""
    cur.execute(sql)
    res1 = cur.fetchall()
