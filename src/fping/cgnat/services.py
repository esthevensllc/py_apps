...
from src.fping.shared.services import LOAD_FPING_CGNAT_FROM_CONFIG
...
class FpingCgnatReportFromConfig:
    def __init__(self, db, oracle_db, repo, control_repo, sftp_service):
        ...
        self.base_storage_dir = f"{STORAGE_DIR}fping_cgnat"
...
class FpingCgnatEventProducerFromConfig(RemoteConnectEventProducer):
...
class FpingCgnatEventConsumerFromConfig(EventConsumerFromConfig):
