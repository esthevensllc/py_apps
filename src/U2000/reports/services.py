...
from src.U2000.shared.services import LOAD_U2000_FROM_CONFIG

class LoadU2000FromConfig(BaseCargaFromConfig):
    def __init__(self, db, repository, sftp_service, control_carga_repo):
        ...
        self.base_storage_dir = f"{STORAGE_DIR}U2000"
...
class U2000EventProducerFromConfig(RemoteConnectEventProducer):
...
class U2000EventConsumerFromConfig(SimpleEventConsumer):
    ...
    def execute(self, group_id=None):
        ...
        for row in cargas:
            ...
            self.queue_handlers[queue_id] = {'handler': LOAD_U2000_FROM_CONFIG, 'callback': lambda s, e: s.event_handler(map_event(e))}
