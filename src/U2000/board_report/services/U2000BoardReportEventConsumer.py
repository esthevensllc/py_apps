...
class U2000BoardReportEventConsumer(SimpleEventConsumer):
    def __init__(self, queue_service, service):
        super().__init__(queue_service)
        self.service = service
        self.queue_names = ['u2000.board_rep_dia.dxd']
        self.queue_handlers = {'u2000.board_rep_dia.dxd': self.handler_hxh}
