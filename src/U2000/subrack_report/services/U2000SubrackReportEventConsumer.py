...
class U2000SubrackReportEventConsumer(SimpleEventConsumer):
    def __init__(self, queue_service, service):
        super().__init__(queue_service)
        self.service = service
        self.queue_names = ['u2000.subrack_rep_dia.dxd']
        self.queue_handlers = {'u2000.subrack_rep_dia.dxd': self.handler_dxd}
