...
class U2000CPU_OCC_ProfileRepository:
    def __init__(self, db):
        self.db = db
        self.table = 'U2000_cpu_occ_profile_15min'
    ...
    def insert_from_array(self, registros_to_insert):
        insert_into_template = """INSERT INTO """+self.table+"""(DEVICEID, DEVICENAME, RESOURCENAME, COLLECTIONTIME, GRANULARITYPERIOD, CPU_OCCUPANCY) VALUES (:1, :2, :3, TO_DATE(:4, 'YYYY-MM-DD HH24:MI:SS'), :5, :6)"""
