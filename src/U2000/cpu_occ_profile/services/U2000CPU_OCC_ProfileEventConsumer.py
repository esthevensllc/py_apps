...
class U2000CPU_OCC_ProfileEventConsumer(SimpleEventConsumer):
    def __init__(self, queue_service, service):
        super().__init__(queue_service)
        self.service = service
        self.queue_names = ['u2000.cpu_occ_15min.hxh']
        self.queue_handlers = {'u2000.cpu_occ_15min.hxh': self.handler_hxh}
