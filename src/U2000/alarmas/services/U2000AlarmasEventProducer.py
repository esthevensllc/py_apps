...
class U2000AlarmasEventProducer(EventRemoteConnectProducer):
    ...
    def get_files_between(self, fecha_ini, fecha_fin):
        server_files = self.get_files_of('/opt/oss/server/var/neftpboot/ftproot/{}'.format(fecha_ini.strftime('%Y%m%d')), 'alarm-log-auto-1')
