...
class NeReportProducer(EventRemoteConnectProducer):
    ...
    def get_files_between(self, fecha_ini, fecha_fin):
        server_files = self.get_files_of('/opt/oss/server/var/neftpboot/ftproot', 'NE_Report_')
