    ...
    def __init__(self, db):
        ...
        self.config_by_id = {
            ...
            "9": {
                ...
                'type': 'inventory',
                'work_dir': 'openapi/neteco/nbi/v2/signal/statistic',
                'api_params': {"typeIds": [60016], "signalIds": [30001, 30004, 30015, 30016]},
                'src_type': "signal-statistic",
                ...
                'fields': [
                    ...
                    {'fieldname': "temperature_2", 'src_fieldname': "30015", 'type': "number", 'to_reload': None},
                    {'fieldname': "temperature_3", 'src_fieldname': "30016", 'type': "number", 'to_reload': None},
                ]
            },
            "10": {
                'id': '10',
            ...
            "30": {
                'id': '30',
                'name': 'stats_site_unit_uponchange',
                'type': 'stats',
                'work_dir': 'openapi/neteco/nbi/v2/signal/statistic',
                'api_params': {
                    "typeIds": [60067],
                    "signalIds": [30002, 30003]
                },
                'src_type': "signal-statistic",
                'file_pattern': 'stats_site_unit_uponchange_([0-9]{10}).json',
                'file_date_format': '%Y%m%d%H',
                'limit_to_commit': 10000,
                'tablename': "neteco_stats_site_unit_uponchange",
                'queue_id': "neteco.stats_site_unit_uponchange",
                'status': 1,
                'reload_by': "file",
                'exec_after_by': None,
                'exec_after_st': None,
                ...
                'fields': [
                    ...
                    {'fieldname': "parentDn", 'src_fieldname': "parentDn", 'type': "varchar2", 'to_reload': None},
                    {'fieldname': "typeId", 'src_fieldname': "typeId", 'type': "number", 'to_reload': None},
                    {'fieldname': "indoor_temperature", 'src_fieldname': "30002", 'type': "number", 'to_reload': None},
                    {'fieldname': "outdoor_temperature", 'src_fieldname': "30003", 'type': "number", 'to_reload': None},
                ]
            },
            "31": {
                'id': '31',
                'name': 'stats_rectifier_group_day',
                'type': 'stats',
                'work_dir': 'openapi/neteco/nbi/v2/signal/statistic',
                'api_params': {"typeIds": [60039], "signalIds": [30006]},
                'src_type': "signal-statistic",
                'file_pattern': 'stats_rectifier_group_day_([0-9]{8}).json',
                'file_date_format': '%Y%m%d',
                'limit_to_commit': 20000,
                'tablename': "neteco_stats_rectifier_group_day",
                'queue_id': "neteco.stats_rectifier_group_day",
                'status': 1,
                'reload_by': "file",
                'exec_after_by': None,
                'exec_after_st': None,
                ...
                'fields': [
                    ...
                    {'fieldname': "parentDn", 'src_fieldname': "parentDn", 'type': "varchar2", 'to_reload': None},
                    {'fieldname': "typeId", 'src_fieldname': "typeId", 'type': "number", 'to_reload': None},
                    {'fieldname': "energy_input", 'src_fieldname': "30006", 'type': 'number', 'to_reload': None},
                ]
            },
        }