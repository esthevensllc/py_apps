...
class ClickHouseDB:
    ...
    def __init__(self):
        self.connections_config = {
            ...
            "clickhouse_nce": {'host': "172.19.242.107", 'user': "desempenio_red", 'password': "D3s3mp3n1oR3d", 'port': 8123, 'database': 'default'},
            "clickhouse_san": {'host': "172.19.242.107", 'user': "desempenio_red", 'password': "D3s3mp3n1oR3d", 'port': 8123, 'database': 'sam_nokia'},
            "clickhouse_apic": {'host': "172.19.242.107", 'user': "desempenio_red", 'password': "D3s3mp3n1oR3d", 'port': 8123, 'database': 'aci_fabric'},
        }
        self.connection_key = ''
        self.db_connections = {}
