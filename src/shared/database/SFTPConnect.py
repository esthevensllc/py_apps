...
class SFTPConnect:
    def __init__(self):
        self.connections = {
            ...
            'arqmedlatf01': {'hostname': os.getenv("SFTP_FPINGCGAR_HOST"), 'username': os.getenv("SFTP_FPINGCGAR_USERNAME"), 'password': os.getenv("SFTP_FPINGCGAR_PASSWORD"), 'port': int(os.getenv("SFTP_FPINGCGAR_PORT", 22))},
        }
